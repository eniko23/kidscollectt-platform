...
class WishlistResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Favori Listeleri';
    protected static ?string $modelLabel = 'Favori Kaydı';
    protected static ?string $pluralModelLabel = 'Favori Kayitları';
