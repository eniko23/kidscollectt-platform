{{-- 
    Bu senin "Tüm Ürünler" (/urunler) sayfan.
    Artık "product-card" component'ini burada kullanıyor.
--}}
<x-layouts.storefront>
    
    <x-slot:title>
        Tüm Ürünler - Kids Collectt
    </x-slot:title>
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-lg text-gray-600 mb-8">
            En yeni ve en güzel ürünlerimiz.
        </p>
        {{-- Başlık bölümü bitti --}}
        ...
        @if(isset($products) && $products->count() > 0)
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 lg:gap-8">
                ...
                {{-- 
                    ❗❗ GÜNCELLEME BURADA ❗❗
                    Eski, çirkin HTML kodunun tamamı silindi.
                    Yerine sadece bu tek satır component çağrısı geldi.
                --}}
